                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-thumbs">
                            <div class="product-thumbs-track ps-slider owl-carousel">
                                ...
                                <div class="pt active" data-imgbigurl="front/img/products/{{ $productImage->path }}"><img src="front/img/products/{{ $productImage->path }}" alt=""></div>
                                @endforeach
                                        ...
                                        @foreach($product->productComments as $productComment)
                                          <div class="co-item">
                                           <div class="avatar-pic">
                                               <img src="front/img/user/{{ $productComment->user->avatar ?? 'avatar-3.png'}}" alt="">
                                           </div>
                                        ...
                                        <form action="" method="post" class="comment-form">
                                            ...
                                            <div class='row'>
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    ...
                                                    <button type="submit" class="site-btn">Send mesage</button>
                                                </div>
                                            </div>    
                                        </form>
                                    </div>
