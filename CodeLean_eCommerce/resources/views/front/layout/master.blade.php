                                               ...
                                               <tr>
                                                   ...
                                                   <td class="si-text">
                                                       <div class="product-selected">
                                                           <p>${{ number_format($cart->price * $cart->qty, 2) }}</p>
                                                           <h6>{{ $cart->name }}</h6>
                                                       </div>
                                                   </td>
                                                   <td class="si-close">
        ...
        <div class="container">
            ...
            <nav class="nav-menu mobile-menu">
                <ul>
                    ...
                    <li class="{{ (request()->segment(1) == 'blog') ? 'active' : '' }}"><a href="./blogs/blog">Blog</a></li>
                    <li class="{{ (request()->segment(1) == 'contact') ? 'active' : '' }}"><a href="./touch/contact">Contact</a></li>
                    <li><a href="">Pages</a>
                        <ul class="dropdown">
